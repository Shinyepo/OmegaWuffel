...
namespace OWuffel.Modules.Commands.Preconditions
{
    public class CustomPreconditions : PreconditionAttribute
    {
        // Create a field to store the specified name
        private readonly string _name;

        // Create a constructor so the name can be specified
        public CustomPreconditions(string name) => _name = name;
